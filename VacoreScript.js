...
function trafficCodes(){
  ...
  $(`.output`).append(`<div class="box salvageButton">Salvage, Nonrepairable, Rebuilt Vehicles</div>`);
...
function miscTraffic(){
  window.location = `#trafficSubsection`;
  $(`.output`).html(`<div class="box codeButton closedBox">Cutting/Injuring Trees, Bridge, Highway, Sign, etc [33.2-801]</div>`);
...
function salvage(){
  window.location = `#trafficSubsection`;
  $(`.output`).html(`<div class="box codeButton closedBox">Definitions [46.2-1600]</div>`);
  $(`.output`).append(`<div class="box codeButton closedBox">Licensing of dealers of salvage vehicles; fees [46.2-1601]</div>`);
  $(`.output`).append(`<div class="box codeButton closedBox">Advertise and display of license; business hours [46.2-1601.1]</div>`);
  $(`.output`).append(`<div class="box codeButton closedBox">Acts of officers, directors, partners [46.2-1601.2]</div>`);
  $(`.output`).append(`<div class="box codeButton closedBox">Grounds for denying, suspending, revoking licenses [46.2-1601.3]</div>`);
  $(`.output`).append(`<div class="box codeButton closedBox">Certain sales prohibited; exceptions [46.2-1602]</div>`);
  $(`.output`).append(`<div class="box codeButton closedBox">Duties of insurance companies upon acquiring certain vehicles [46.2-1602.1]</div>`);
  $(`.output`).append(`<div class="box codeButton closedBox">Exemptions [46.2-1602.2]</div>`);
  $(`.output`).append(`<div class="box codeButton closedBox">Obtaining salvage certificate or certificate of title for unrecovered stolen vehicle [46.2-1603]</div>`);
  $(`.output`).append(`<div class="box codeButton closedBox">Duties of licensees [46.2-1603.1]</div>`);
  $(`.output`).append(`<div class="box codeButton closedBox">Owner may declare vehicle nonrepairable; requirements, applicabilities, prohibitions [46.2-1603.2]</div>`);
  $(`.output`).append(`<div class="box codeButton closedBox">Rebuilders required to possess certificate of title or salvage certificate [46.2-1604]</div>`);
  $(`.output`).append(`<div class="box codeButton closedBox">Vehicles rebuilt for highway use; examinations; branding of titles [46.2-1605]</div>`);
  $(`.output`).append(`<div class="box codeButton closedBox">Certificate of title issued by other states; nonnegotiable titles [46.2-1606]</div>`);
  $(`.output`).append(`<div class="box codeButton closedBox">Inspection of records and examination of inventory [46.2-1607]</div>`);
  $(`.output`).append(`<div class="box codeButton closedBox">Maintenance and contents of records [46.2-1608]</div>`);
  $(`.output`).append(`<div class="box codeButton closedBox">Reports to police; local ordinance; holding period; penalty [46.2-1608.1]</div>`);
  $(`.output`).append(`<div class="box codeButton closedBox">Licensees to update records for demolished vehicles [46.2-1608.2]</div>`);
  $(`.output`).append(`<div class="box codeButton closedBox">Penalties [46.2-1609]</div>`);
  $(`.output`).append(`<div class="box trafficButton">Return to Traffic Codes</div>`);
  ...
  if (divTarget.hasClass(`closedBox`) && !divTarget.hasClass(`openBox`)){   //if box is still closed
    ...
    ajaxObj.done(function(data){
      try {
        ...
        $(`.fa-spinner`).remove();
        divTarget.append(`<br><p>An error occured.  The state's website may be down.  Please try again later, or e-mail <a href='mailto:marcfogleman@gmail.com.com'>MarcFogleman@gmail.com</a> if the problem persists</p><p></p>` );
        divTarget.removeClass(`closedBox`);
        console.log(e);
      }
    });
